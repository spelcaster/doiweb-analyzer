...
use DOIWeb\Package\Adquirente;
use DOIWeb\Fields\FieldFactory;
use RuntimeException;

/**
 * Class AdquirenteParser
 * @author yourname
 */
class AdquirenteParser implements DOI6ParserInterface
{
    public function parseDOI6($line)
    {
        ...
        throw new RuntimeException(
            "Failed to parse 'Adquirente' with payload '{$backupLine}' ('{$line}')"
        );
    }
}
